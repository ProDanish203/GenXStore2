      ...
      <section className="glassmorphism">
        <div className="flex max-lg:flex-col gap-5">
          ...
          <div className="pt-10 max-lg:px-3 max-lg:pb-5">
            <h2 className="text-text text-2xl font-extrabold">{data?.title}</h2>
            <p className="text-sm font-light text-primary">
              Category &gt; {data?.cat}
            </p>

            <div className="lg:mt-10 mt-5">
              <p className="text-text flex items-center gap-2 hover:gap-4">
            ...
            <div className="mt-5">
              {data?.price.map((price: any, i: number) => (
                <div className="relative" key={i}>
                  <p className="lg:text-3xl text-xl block font-extrabold text-text">
                    {price.ct} {price.rate}
                  </p>
                  <div className="flex gap-2 items-center">
                    <p className="old-rate lg:text-lg font-light text-gray-300">
                      {price.oldRate}
                    </p>
            ...
            <p className="text-text text-xl font-bold flex items-center gap-2 hover:gap-4 mt-5">
            ...
            <div className="mt-5 w-full">
              <Link
                ...
                target="_blank"
                className="text-text bg-primary py-2.5 text-center w-full px-10 max-lg:w-full block rounded-md font-semibold"
              >
                Buy Now
              </Link>
            </div>
