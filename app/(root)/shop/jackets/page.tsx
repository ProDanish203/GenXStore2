...
const Watches = () => {
  ...
  return (
    <main className='px-[9%] mt-16 max-lg:px-[4%] py-5 pt-24'>
      ...
      <Banner heading="Leather Jackets Winter Collection is here" text="Introducing GenX Store 2's Winter Wonderland: Embrace the Chill in Style! Explore Our Latest Collection of Cozy and Trendy Winter Jackets. ❄️ Your Winter Wardrobe Upgrade Starts Here – Shop Now for the Hottest Looks to Keep You Cool in the Cold! 🧥" image='/images/jackets/banner.jpg'/>
