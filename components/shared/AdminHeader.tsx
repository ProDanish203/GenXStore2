...
export const AdminHeader = () => {
  ...
  return (
    <header
      className={` bg-bg z-40 fixed top-0 left-0 w-full  flex items-center justify-between px-10 gap-3 `}
    >
      <Link
        href="/"
      ...
      {mobileNav && (
        <nav
          className="md:hidden max-w-[250px] w-full flex flex-col gap-4 absolute z-50 top-[80%] right-5 justify-center glassmorphism text-black px-3 rounded-md shadow-sm"
          data-aos="fade-up"
          data-aos-delay="100"
